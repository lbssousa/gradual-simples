...
%\input{graduale-simplex/tempus-quadragesimae/dominica-2}{index}

%\tocsection{III Domingo}\label{section:tempus-quadragesimae/dominica-3}
%\input{graduale-simplex/tempus-quadragesimae/dominica-3}{index}

%\tocsection{IV Domingo}\label{section:tempus-quadragesimae/dominica-4}
%\input{graduale-simplex/tempus-quadragesimae/dominica-4}{index}

%\tocsection{V Domingo}\label{section:tempus-quadragesimae/dominica-5}
%\input{graduale-simplex/tempus-quadragesimae/dominica-5}{index}
...
%\input{graduale-simplex/hebdomada-sancta/dominica-in-palmis-de-passione-domini}{index}

%\tocsectioncomplex{Missa do Crisma}{Quinta-feira da Semana Santa}{}\label{section:hebdomada-sancta/missa-chrismatis}
%\input{graduale-simplex/hebdomada-sancta/missa-chrismatis}{index}
...
%\input{graduale-simplex/hebdomada-sancta/missa-in-cena-domini}{index}

%\tocsection{Sexta-feira da Paixão do Senhor}\label{section:hebdomada-sancta/feria-6-in-passione-domini}
%\input{graduale-simplex/hebdomada-sancta/feria-6-in-passione-domini}{index}

%\tocsection{Vigília Pascal na Noite Santa}\label{section:hebdomada-sancta/ad-vigiliam-paschalem-in-nocte-sancta}
%\input{graduale-simplex/hebdomada-sancta/ad-vigiliam-paschalem-in-nocte-sancta}{index}
...
%\input{graduale-simplex/tempus-paschale/dominica-resurrectionis}{index}

%\tocsectioncomplex{Missa I}{Para uso preferencial da II até a IV semana do Tempo Pascal}{}\label{section:tempus-paschale/missa-1}
%\input{graduale-simplex/tempus-paschale/missa-1}{index}

%\tocsection{Missa II}{Para uso preferencial da V à VII semana do Tempo Pascal}{}\label{section:tempus-paschale/missa-2}
%\input{tempus-paschale/missa-2}{index}

%\Solemnitas{Ascensão do Senhor}{}\label{section:tempus-paschale/in-ascencione-domini}
%\input{graduale-simplex/tempus-paschale/in-ascencione-domini}{index}

%\Solemnitas{Domingo de Pentecostes}{}\label{section:tempus-paschale/dominica-pentecostes}
%\input{graduale-simplex/tempus-paschale/dominica-pentecostes}{index}
...
%\input{fasciculo-2/appendices/communio-ad-libitum}
