...
\NewDocumentCommand \MakeVerseItemL { m m } {%
  \IfBlankF{#1}{#1~\@Link@Text@L}%
}
\NewDocumentCommand \MakeVerseItemR { m m } {%
  \IfBlankF{#2}{#2~\@Link@Text@R}%
}
...
\NewDocumentCommand \MakeChantPsalm { m m O{} O{#3} } {
  \SetVersePairs{}
...
\NewDocumentCommand \MakeChantPsalmMulti { m m m O{} O{#4} } {
...
\NewDocumentCommand \SectionAlleluiaPsalm { s O{} m m m } {
  ...
  \MakeChantAlleluia{#3}
  \nobreaksubsection{#4}
  \MakeChantPsalm{psalmi-ad-alleluia}{#5}[\begin{rubrica}Todos:\end{rubrica} Allelúia.][\begin{rubrica}Todos:\end{rubrica} Aleluia.]
}
...
\NewDocumentCommand \SectionPsalm { s O{} m O{} m m m } {
  ...
  \MakeChantPsalm{#6}{#7}[\Responsorium]
}

\NewDocumentCommand \SectionPsalmMulti { s O{} m O{} m m m m } {
  \subsection{Salmo #3 --- #5}\IfBlankF{#4}{\label{#4}}
  \IfBlankF{#2}{%
    \begin{rubrica}
      \begin{center}
  ...
  \MakeChantPsalmMulti{#6}{#7}{#8}[\Responsorium]
}
