...
\NewDocumentCommand \SectionAntiphon { s O{} m O{} m O{} } {
  \subsection{Antífona \IfBooleanF{#1}{de} #3}\IfBlankF{#4}{\label{#4}}
...
\NewDocumentCommand \SectionNamedAlleluiaPsalm { O{} m m m m } {
  \subsection{Aleluia #2}\IfBlankF{#1}{\label{#1}}
  \MakeChantAlleluia{#3}
  \subsubsection{#4}
...
\NewDocumentCommand \SectionChant { O{} m O{} m m m } {
  \subsection{Canto #2}\IfBlankF{#3}{\label{#3}}
  \subsubsection{#4}
  \IfBlankF{#1}{%
    \begin{rubrica}
      #1
...
\NewDocumentCommand \SectionHymnMulti { O{} m O{} m m m } {
  \subsection{Hino #2}\IfBlankF{#3}{\label{#3}}
  \IfBlankF{#1}{%
    \begin{rubrica}
      #1
    \end{rubrica}%
