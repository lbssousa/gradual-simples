...
\subsection{Comunhão I}\label{appendix:communio-ad-libitum/communio-1}
...
\MakeChantLongPsalm*{appendices/communio-ad-libitum/}{communio-1/}{
...
\subsectioncomplex{Comunhão II}{}{Para uso preferencial durante o Tempo da Quaresma}\label{appendix:communio-ad-libitum/communio-2}

\grechangedim{baselineskip}{66pt plus 5pt minus 5pt}{scalable}
\MakeChantPsalmOneVerse*{\Prefix}{communio-2/}
...
\begin{rubrica}
  Ver Comum de Nossa Senhora, página~\pageref{subsection:communia/commune-bmv/communio-2}.
\end{rubrica}
...
\end{annotation}
\MakeChantLongPsalm{\Prefix}{communio-5/}{
  {psalmus-v1}{psalmus-v1-pt},
