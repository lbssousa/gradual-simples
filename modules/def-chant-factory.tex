...
\newcommand{\MakeVerseItemL}[2]{\MakeVerseL{\item #1}{\item #2}}
\newcommand{\MakeVerseItemR}[2]{\MakeVerseR{\item #1}{\item #2}}
\newcommand{\MakeVerseItemLR}[2]{\MakeVerseLR{\item #1}{\item #2}}

\newcommand{\MakeVerseItemVoidL}[2]{\MakeVerseL{\item[] #1}{\item[] #2}}
\newcommand{\MakeVerseItemVoidR}[2]{\MakeVerseR{\item[] #1}{\item[] #2}}
\newcommand{\MakeVerseItemVoidLR}[2]{\MakeVerseLR{\item[] #1}{\item[] #2}}
...
\NewDocumentCommand{\MakeChantPsalmOneVerse}{s m m}{
  ...
  \iftoggle{compact}{
    ...
    \begin{greenumerate}
      ...
      \IfBooleanT{#1}{\Map{\MakeVerseItemVoidL}{\GloriaPatriPair}}
    \end{greenumerate}
    ...
    \begin{greenumerate}
      ...
      \IfBooleanT{#1}{\Map{\MakeVerseItemVoidR}{\GloriaPatriPair}}
    \end{greenumerate}
    ...
    \begin{greenumerate}
      \begin{paracol}{2}
        ...
        \IfBooleanT{#1}{\Map{\MakeVerseItemVoidLR}{\GloriaPatriPair}}
      \end{paracol}
    \end{greenumerate}
  }
}
...
\NewDocumentCommand{\MakeChantPsalmTwoVerses}{s m m}{
  ...
  \iftoggle{compact}{
    ...
    \GregorioImportL*{#2}{#3}{psalmus-v1}{psalmus-v1-pt}
    \GregorioImportL*{#2}{#3}{psalmus-v2}{psalmus-v2-pt}
    ...
    \makeatother
    \GregorioImportR*{#2}{#3}{psalmus-v1}{psalmus-v1-pt}
    \GregorioImportR*{#2}{#3}{psalmus-v2}{psalmus-v2-pt}
    ...
    \begin{paracol}{2}
      \GregorioImportLR*{#2}{#3}{psalmus-v1}{psalmus-v1-pt}
      \GregorioImportLR*{#2}{#3}{psalmus-v2}{psalmus-v2-pt}
    \end{paracol}
...
\NewDocumentCommand{\MakeChantPsalmThreeVerses}{s m m}{
  ...
  \iftoggle{compact}{
    ...
    \GregorioImportL*{#2}{#3}{psalmus-v1}{psalmus-v1-pt}
    \GregorioImportL*{#2}{#3}{psalmus-v2}{psalmus-v2-pt}
    \GregorioImportL*{#2}{#3}{psalmus-v3}{psalmus-v3-pt}
    ...
    \GregorioImportR*{#2}{#3}{psalmus-v1}{psalmus-v1-pt}
    \GregorioImportR*{#2}{#3}{psalmus-v2}{psalmus-v2-pt}
    \GregorioImportR*{#2}{#3}{psalmus-v3}{psalmus-v3-pt}
    ...
    \begin{paracol}{2}
      \GregorioImportLR*{#2}{#3}{psalmus-v1}{psalmus-v1-pt}
      \GregorioImportLR*{#2}{#3}{psalmus-v2}{psalmus-v2-pt}
      \GregorioImportLR*{#2}{#3}{psalmus-v3}{psalmus-v3-pt}
    \end{paracol}
...
\NewDocumentCommand{\MakeChantAntiphonPsalm}{s m m O{}}{
  ...
  \iftoggle{compact}{
    ...
    \nottoggle{disablehyperlinks}{
      \begin{small}
        \noindent\hyperlink{#2#3antiphona-pt}{Ir para a adaptação para o vernáculo}
      \end{small}
      \vspace{-10pt}
    }{}
    \GregorioImportL{#2}{#3}{antiphona}{antiphona-pt}
    \GregorioImportL*{#2}{#3}{psalmus}{psalmus-pt}
    ...
    \nottoggle{disablehyperlinks}{
      \begin{small}
        \noindent\hyperlink{#2#3antiphona}{Ir para o original em latim}
      \end{small}
      \vspace{-10pt}
    }{}
    \makeatother
    \GregorioImportR{#2}{#3}{antiphona}{antiphona-pt}
    \GregorioImportR*{#2}{#3}{psalmus}{psalmus-pt}
    ...
    \begin{paracol}{2}
      \GregorioImportLR{#2}{#3}{antiphona}{antiphona-pt}
      \GregorioImportLR*{#2}{#3}{psalmus}{psalmus-pt}
    \end{paracol}
...
\NewDocumentCommand{\MakeChantLongPsalm}{s m m m}{
  ...
  \renewcommand{\DoGregorioImportL}[2]{\iftoggle{biginitial}{\GregorioImportL{#2}{#3}{##1}{##2}\togglefalse{biginitial}}{\GregorioImportL*{#2}{#3}{##1}{##2}}}
  \renewcommand{\DoGregorioImportR}[2]{\iftoggle{biginitial}{\GregorioImportR{#2}{#3}{##1}{##2}\togglefalse{biginitial}}{\GregorioImportR*{#2}{#3}{##1}{##2}}}
  \renewcommand{\DoGregorioImportLR}[2]{\iftoggle{biginitial}{\GregorioImportLR{#2}{#3}{##1}{##2}\togglefalse{biginitial}}{\GregorioImportLR*{#2}{#3}{##1}{##2}}}
  \iftoggle{compact}{
    \nottoggle{disablehyperlinks}{
      \begin{small}
        \noindent\hyperlink{#2#3psalmus-v1-pt}{Ir para a adaptação para o vernáculo}
