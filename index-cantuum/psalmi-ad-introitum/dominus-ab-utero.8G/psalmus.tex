\SetVersePairs{
  ...
  {\item \VSup{14}\Inchoatio{Plan}{tá}ti in domo \MediatioVIII{Dó}[mini,] in átriis Dei no\TerminatioVIII{stri}[ ]{flo}{ré}bunt.~\Antiphona}%
    {\item \VSup{14}\Inchoatio{Na}[ ]{ca}sa do Senhor estão plan\MediatioVIII{ta}[dos,] nos átris de meu Deus flo\TerminatioVIII{res}{ce}{rão}.~\Antiphona},
  ...
  {\item \VSup{16}\Inchoatio{Ut}[ ]{an}núntient quóniam rectus Dóminus, refúgium \MediatioVIII{me}[\-um,] et non est iníqui\TerminatioVIII{tas}[ ]{in}[ ]{e}o.~\Antiphona}%
    {\item \VSup{16}\Inchoatio{E}[ ]{di}rão: ``É justo mesmo o Senhor \MediatioVIII{Deus}[:] meu Rochedo, não existe \TerminatioVIII{ne}{l\itie{e o}}[ ]{mal}!''~\Antiphona}
}