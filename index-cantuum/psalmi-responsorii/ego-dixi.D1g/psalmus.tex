...
\SetVersePairs{
  ...
  {\VSup{7}Et si ingrediebátur, ut visitáret, vana loque\Flexa*{bá}[tur;] cor eius congregábat iniquitátem \MediatioD{si}[bi,] egrediebátur foras et detra\TerminatioDI{hé}bat.}%
    {\VSup{7}Se alguém me visita, é com dupla \Flexa*{in}[tenção:] recolhe más notícias no seu \MediatioD{co}[ração,] e, apenas saindo, ele corre a espa\TerminatioDI{lhá}-las.},
  {\VSup{8}Simul advérsum me susurrábant omnes inimíci \MediatioD{me}[i;] advérsum me cogitábant mala \TerminatioDI{mi}{hi:}}%
    {\VSup{8}Vaticinam desgraças os meus ini\MediatioD{mi}[gos;] reunidos, sussurram o mal \TerminatioDI{con}tra mim:},
  {\VSup{9}``Malefícium effúsum est in \MediatioD{e}[o;] et qui decúmbit non adíciet ut re\TerminatioDI{súr}gat''.}%
    {\VSup{9}``Uma peste incurável caiu sobre \MediatioD{e}[le,] e do leito em que jaz nunca mais se \TerminatioDI{er}guerá!''},
  {\VSup{10}Sed et homo pacis meæ, in quo spe\MediatioD{rá}[vi,] qui edébat panem meum, levávit contra me cal\TerminatioDI{cá}neum.}%
    {\VSup{10}Até mesmo o amigo em quem mais confi\MediatioD{a}[va,] que comia o meu pão, me calcou sob \TerminatioDI{os} pés.}
}