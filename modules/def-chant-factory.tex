...
\def\@Antiphon@Score{} % chktex 21
\def\@Antiphon@Annotation{} % chktex 21
\def\@Verse@Annotation{} % chktex 21
\newcommand{\SetAntiphonScore}[1]{\def\@Antiphon@Score{#1}} % chktex 21
\newcommand{\SetAntiphonAnnotation}[1]{\def\@Antiphon@Annotation{#1}} % chktex 21
\newcommand{\SetVerseAnnotation}[1]{\def\@Verse@Annotation{#1}} % chktex 21
\makeatother
...
\makeatletter
\NewDocumentCommand{\MakeChantAntiphonPsalm}{s m O{\@Antiphon@Score} O{}}{
  ...
  \iftoggle{compact}{
    ...
    \GregorioImportL{index-cantuum/antiphonae/}{\@Antiphon@Score}{\AntiphonLA}{\AntiphonPT}
    ...
    \GregorioImportR{index-cantuum/antiphonae/}{\@Antiphon@Score}{\AntiphonLA}{\AntiphonPT}
    ...
    \begin{paracol}{2}
      \GregorioImportLR{index-cantuum/antiphonae/}{\@Antiphon@Score}{\AntiphonLA}{\AntiphonPT}
...
\NewDocumentCommand{\MakeChantAntiphonPsalmExtended}{s m O{\@Antiphon@Score} m}{%
  \IfBooleanTF{#1}{%
    \MakeChantAntiphonPsalm*{#2}[#3][#4]%
  }{%
    \MakeChantAntiphonPsalm{#2}[#3][#4]}%
}

\NewDocumentCommand{\MakeChantAntiphon}{s m O{\@Antiphon@Score}}{
  \def\AntiphonLA{antiphona\IfBooleanT{#1}{-cum-alleluia}}
  \def\AntiphonPT{\AntiphonLA-pt}
  \input{#2#3psalmus}
