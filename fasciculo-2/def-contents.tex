...
\gabcsnippet{(c3) O(f)re(h)mos,(h) ir(h)mãos(h) e(h) ir(h)mãs(h) ca(h)rís(h)si(h)mos,(h) pe(h)la(h) san(h)ta(h) I(h)gre(h)ja(g) de(f) Deus:(g) (;) que(f) o(h) Se(h)nhor(h) nos(h)so(h) Deus(h) lhe(h) dê(h) a(h) paz(h) e(h) a(h) u(h)ni(h)da(h)de,(h) (,) que(h) e(h)le(h) a(h) pro(h)te(h)ja(h) por(h) to(h)da(g) a(f) ter(g)ra(g) (,) e(f) nos(h) con(h)ce(h)da(h) u(h)ma(h) vi(h)da(h) cal(h)ma(h) e(g) tran(f)qui(g)la,(g) (,) pa(g)ra(g) su(g)a(g) pró(e)pria(f) gló(g)ria.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\gabcsnippet{(c3) O(f)re(h)mos(h) pe(h)lo(h) nos(h)so(h) san(h)to(h) Pa(h)dre,(h) o(h) Pa(h)pa(h) <v>(</v>N.<v>)</v>(h) (g) (f) (g) (;) O(f) Se(h)nhor(h) nos(h)so(h) Deus,(h) que(h) o(h) es(h)co(h)lheu(h) pa(h)ra(h) o(h) E(h)pis(g)co(f)pa(g)do,(g) (,) o(f) con(h)ser(h)ve(h) são(h) e(h) sal(h)vo(h) à(h) fren(h)te(h) da(h) su(h)a(g) I(f)gre(g)ja,(g) (,) go(g)ver(g)nan(g)do(g) o(g) po(e)vo(f) de(g) Deus.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\subsubsection{III. Por todas as ordens e categorias de fiéis}

\gabcsnippet{(c3) O(f)re(h)mos(h) pe(h)lo(h) nos(h)so(h) bis(h)po(h) <v>(</v>N.<v>)</v>,(h) (g) (f) (g) (,) por(f) to(h)dos(h) os(h) bis(h)pos,(h) pres(h)bí(h)te(h)ros(h) e(h) di(h)á(h)co(h)nos(h) da(g) I(f)gre(g)ja(g) (,) e(g) por(g) to(g)do(g) o(g) po(e)vo(f) fi(g)el.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\gabcsnippet{(c3) O(f)re(h)mos(h) pe(h)los(h) <v>(</v>nos(h)sos<v>)</v>(h) ca(g)te(f)cú(g)me(g)nos:(g) (;) que(f) o(h) Se(h)nhor(h) nos(h)so(h) Deus(h) a(h)bra(h) os(h) seus(h) co(h)ra(h)ções(h) e(h) as(h) por(h)tas(h) da(h) mi(h)se(g)ri(f)cór(g)dia,(g) (,) pa(f)ra(h) que,(h) ten(h)do(h) re(h)ce(h)bi(h)do(h) nas(h) á(h)guas(h) do(h) ba(h)tis(h)mo(h) o(h) per(h)dão(h) de(h) to(h)dos(h) os(h) seus(g) pe(f)ca(g)dos,(g) (,) se(g)jam(g) in(g)cor(g)po(g)ra(h)dos(g) no(g) Cris(e)to(f) Je(g)sus.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\gabcsnippet{(c3) O(f)re(h)mos(h) pe(h)los(g) ju(f)deus,(g) (,) aos(f) quais(h) o(h) Se(h)nhor(h) nos(h)so(h) Deus(h) fa(h)lou(h) em(h) pri(h)mei(h)ro(g) lu(f)gar,(g) (,) a(g) fim(g) de(g) que(g) cres(g)çam(g) na(g) fi(g)de(g)li(g)da(g)de(g) de(g) su(g)a(g) a(g)li(g)an(h)ça(g) (,) e(g) no(g) a(g)mor(g) do(e) seu(f) no(g)me.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\subsubsection{VIII. Pelos que não creem em Deus}

\gabcsnippet{(c3) O(f)re(h)mos(h) pe(h)los(h) que(h) não(h) re(h)co(h)nhe(h)cem(g) a(f) Deus,(g) (,) pa(f)ra(h) que,(h) bus(h)can(h)do(h) le(h)al(h)men(h)te(h) o(h) que(g) é(f) re(g)to,(g) (,) pos(g)sam(g) che(g)gar(h) ao(g) Deus(g) ver(e)da(f)dei(g)ro.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\gabcsnippet{(c3) O(f)re(h)mos(h) por(h) to(h)dos(h) os(h) go(g)ver(f)nan(g)tes:(g) (;) que(f) o(h) nos(h)so(h) Deus(h) e(h) Se(h)nhor,(h) se(h)gun(h)do(h) su(h)a(h) von(h)ta(h)de,(h) lhes(h) di(h)ri(h)ja(h) o(h) es(h)pí(h)ri(h)to(h) e(h) o(h) co(g)ra(f)ção(g) (,) pa(g)ra(g) que(g) to(g)dos(g) pos(g)sam(g) go(g)zar(h) da(g) ver(g)da(g)dei(g)ra(g) paz(g) e(g) li(e)ber(f)da(g)de.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
...
\subsubsection{X. Por todos os que sofrem provações}

\gabcsnippet{O(f)re(h)mos,(h) ir(h)mãos(h) e(h) ir(h)mãs,(h) a(h) Deus(h) Pai(h) to(h)do-(h)po(g)de(f)ro(g)so,(g) (,) pa(f)ra(h) que(h) li(h)vre(h) o(h) mun(h)do(h) de(h) to(g)do(f) er(g)ro,(g) (,) ex(f)pul(h)se(h) as(g) do(f)en(g)ças(g) (,) e(f) a(h)fu(h)gen(h)te(g) a(f) fo(g)me,(g) (,) a(f)bra(h) as(g) pri(f)sões(g) (,) e(f) li(h)ber(h)te(h) os(g) ca(f)ti(g)vos,(g) (,) ve(f)le(h) pe(h)la(h) se(h)gu(h)ran(h)ça(h) dos(h) vi(h)a(h)jan(h)tes(h) e(h) tran(g)se(f)un(g)tes,(g) (,) re(f)pa(h)tri(h)e(h) os(h) e(g)xi(f)la(g)dos,(g) (,) dê(f) sa(h)ú(h)de(h) aos(g) do(f)en(g)tes(g) (,) e(g) a(g) sal(g)va(g)ção(g) aos(g) que(g) a(e)go(f)ni(g)zam.(f) (::) <c><i>Opcional</i>:</c>() A(c)jo(e)e(f)lhe(g)mo-(f)nos!(f) (::) Le(f)van(f)tai-(ef)vos!(f) (::)}
