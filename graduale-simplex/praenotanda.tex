...
Como praticamente não existem palavras oxítonas na língua latina, não há uma forma única de acomodar as melodias dos tons salmódicos a versos em língua portuguesa terminados em palavras oxítonas. Apresentaremos a seguir as duas formas mais comuns de aplicar a acomodação melódica nestes casos, que denominaremos aqui \emph{acomodação latinizada} (ou da ``falsa proparoxítona'') e \emph{acomodação sinerética}:

\begin{description}
  \item[Acomodação latinizada:] o último acento melódico recai sobre a antepenúltima sílaba da frase, e os neumas pós-acento recaem sobre a penúltima e a última sílaba da frase.

  \item[Acomodação sinerética:] o último acento melódico recai, juntamente com os neumas pós-acento, sobre a última sílaba da frase, num processo de sinérese dos neumas.
\end{description}
...
\begin{center}
  \begin{tabular}{rl}
    ...
    LS   & Laércio de Sousa                      \\
    WL   & Willian Lovato                        \\
    MR97 & Missal Romano, 2ª Edição (CNBB, 1997) \\
  \end{tabular}
\end{center}
