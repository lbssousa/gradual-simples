...
\NewDocumentCommand{\MakeChantPsalmOneVerse}{s m m}{
  \def\@Link@Ref@L{index-cantuum/#2#3psalmus-v1}
  \def\@Link@Ref@R{index-cantuum/#2#3psalmus-v1-pt}
  \input{index-cantuum/#2#3psalmus}

  \begin{annotation}
    \MakeAnnotation{}{\@Verse@Annotation}
  \end{annotation}
...
\NewDocumentCommand{\MakeChantAntiphonPsalm}{s m m O{#2} O{}}{
  \def\@Antiphon@L{antiphona\IfBooleanT{#1}{-cum-alleluia}}
  \def\@Antiphon@R{\@Antiphon@L-pt}
  \def\@Link@Ref@L{index-cantuum/#3#4\@Antiphon@L}
  \def\@Link@Ref@R{index-cantuum/#3#4\@Antiphon@R}
  \input{index-cantuum/antiphonae/#2antiphona}
  \input{index-cantuum/#3#4psalmus}

  \begin{annotation}
    \MakeAnnotation{\@Antiphon@Annotation}{\@Verse@Annotation}
  \end{annotation}
...
\NewDocumentCommand{\MakeChantAntiphonPsalmExtended}{s m m O{#2} m}{%
  \IfBooleanTF{#1}{%
    \MakeChantAntiphonPsalm*{#1}{#2}{#3}[#4][#5]%
  }{%
    \MakeChantAntiphonPsalm{#2}{#3}[#4][#5]%
  }%
}

\NewDocumentCommand{\MakeChantAntiphon}{s m m O{#2}}{
  \def\@Antiphon@L{antiphona\IfBooleanT{#2}{-cum-alleluia}}
  \def\@Antiphon@R{\@Antiphon@L-pt}
  \def\@Link@Ref@L{index-cantuum/#3#4\@Antiphon@L}
  \def\@Link@Ref@R{index-cantuum/#3#4\@Antiphon@R}
  \input{index-cantuum/antiphonae/#2antiphona}
  ...
  \begin{annotation}
    \MakeAnnotation{\@Antiphon@Annotation}{}
  \end{annotation}
  ...
  \iftoggle{compact}{
    ...
    \GregorioImportL{#2}{#3}{\@Antiphon@L}{\@Antiphon@R}
    ...
    \GregorioImportR{#2}{#3}{\@Antiphon@L}{\@Antiphon@R}

    \clearpage
  }{
    \begin{paracol}{2}
      \GregorioImportLR{#2}{#3}{\@Antiphon@L}{\@Antiphon@R}
    \end{paracol}
  }
}
...
\NewDocumentCommand{\MakeChantAlleluiaPsalm}{m m O{}}{
  ...
  \def\@Antiphon@R{\@Antiphon@L-pt}
  \def\@Link@Ref@L{index-cantuum/alleluia/#2\@Antiphon@L}
  \def\@Link@Ref@R{index-cantuum/alleluia/#2\@Antiphon@R}
  \input{index-cantuum/antiphonae/alleluia.#1/antiphona}
  \input{index-cantuum/alleluia/#2psalmus}
  ...
  \iftoggle{compact}{
    ...
    \GregorioImportL*{index-cantuum/alleluia/}{#2}{psalmus}{psalmus-pt}
    ...
    \GregorioImportR*{index-cantuum/alleluia/}{#2}{psalmus}{psalmus-pt}
    ...
    \begin{paracol}{2}
      ...
      \GregorioImportLR*{index-cantuum/alleluia/}{#2}{psalmus}{psalmus-pt}
    \end{paracol}
