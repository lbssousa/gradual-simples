...
\MakeChantAntiphonPsalm{dilexisti-iustitiam.8G}{psalmi-ad-introitum}

\AllowPageFlush

\subsection{Entrada II}\label{subsection:communia/commune-sanctarum/introitus-2}
\MakeChantAntiphonPsalm{veni-sponsa-christi.7c}{psalmi-ad-introitum}
...
\MakeChantAntiphonPsalm{afferentur-in-laetitia.2D}{psalmi-ad-offertorium}

\AllowPageFlush

\subsection{Ofertório II}\label{subsection:communia/commune-sanctarum/offertorium-2}
\MakeChantAntiphonPsalm{diffusa-est-gratia.1g4}[1]{psalmi-ad-offertorium}[diffusa-est-gratia.1g4.1/]

\AllowPageFlush

\subsection{Comunhão I}\label{subsection:communia/commune-sanctarum/communio-1}
\MakeChantAntiphonPsalm{media-nocte.4A}{psalmi-ad-communionem}

\AllowPageFlush

\subsection{Comunhão II}\label{subsection:communia/commune-sanctarum/communio-2}
\MakeChantAntiphonPsalm{prudentes-virgines.4A}{psalmi-ad-communionem}