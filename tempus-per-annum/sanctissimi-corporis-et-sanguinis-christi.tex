...
\def\AntiphonScore{sacerdos-in-aeternum.1f/}
\MakeChantAntiphonPsalm*{introitus/}{sacerdos-in-aeternum.1f/}
...
\MakeChantAntiphonPsalm{alleluia/}{attendite-popule-meus.3g/}
...
\def\AntiphonAnnotation{\CantusID{020028}[Sb 16,20]}
\def\AntiphonScore{angelorum-esca.2D/}
\MakeChantAntiphonPsalm*{offertorium/}{angelorum-esca.2D/}

\AllowPageFlush

\subsection{Comunhão}\label{subsection:tempus-per-annum/sanctissimi-corporis-et-sanguinis-christi/communio}
\def\AntiphonAnnotation{\CantusID{002595}[Jo 6,51]}
\def\AntiphonScore{ego-sum-panis-vivus.1f/}
\MakeChantAntiphonPsalm*{communio/}{ego-sum-panis-vivus.1f/}
