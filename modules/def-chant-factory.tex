...
\NewDocumentCommand \SectionAntiphon { s O{} m O{} m O{} } {
  \section*{Antífona \IfBooleanF{#1}{de} #3}\IfBlankF{#4}{\label{#4}}
...
\NewDocumentCommand \SectionAntiphonMulti { O{} m O{} m m m m } {
...
\NewDocumentCommand \SectionAlleluiaPsalm { O{} m m m } {
  \section*{Aleluia}\IfBlankF{#1}{\label{#1}}
  \MakeChantAlleluia{#2}
  \subsection*{#3}
  \MakeChantPsalm{psalmi-ad-alleluia}{#4}
}

\NewDocumentCommand \SectionNamedAlleluiaPsalm { O{} m m m m } {
  \section*{Aleluia #2}\IfBlankF{#1}{\label{#1}}
  \MakeChantAlleluia{#3}
  \subsection*{#4}
...
\NewDocumentCommand \SectionPsalm { O{} m O{} m m m } {
  \section*{Salmo #2}\IfBlankF{#3}{\label{#3}}
  \subsection*{#4}
  \IfBlankF{#1}{%
    \begin{rubrica}
      #1
...
\NewDocumentCommand \SectionChant { O{} m O{} m m m } {
  \section*{Canto #2}\IfBlankF{#3}{\label{#3}}
  \subsection*{#4}
  \IfBlankF{#1}{%
    \begin{rubrica}
      #1
...
\NewDocumentCommand \SectionChantMulti { O{} m O{} m m m m } {
  \section*{Canto #2}\IfBlankF{#3}{\label{#3}}
  \subsection*{#4}
  \IfBlankF{#1}{%
    \begin{rubrica}
...
\NewDocumentCommand \SectionHymnMulti { O{} m O{} m m m } {
  \section*{Hino #2}\IfBlankF{#3}{\label{#3}}
  \IfBlankF{#1}{%
    \begin{rubrica}
      #1
    \end{rubrica}%
  }
  \MakeChantHymnMulti{#4}{#5}{#6}
}

\NewDocumentCommand \SectionTractus { O{} m m } {
  \section*{Trato}\IfBlankF{#1}{\label{#1}}
  \subsection*{#2}
