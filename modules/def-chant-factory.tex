...
\NewDocumentCommand \MakeChantAntiphon { s m O{} } {
  \def\@Antiphon@L{antiphona\IfNoValueOrEmptyTF{#3}{}{.#3}}
...
\NewDocumentCommand \MakeChantPsalmMulti { s m m m } {
  \renewcommand{\DoGregorioImportL}[2]{\GregorioImportL*{index-cantuum/#2}{#3}{##1}{##2}}
  \renewcommand{\DoGregorioImportR}[2]{\GregorioImportR*{index-cantuum/#2}{#3}{##1}{##2}}
  \renewcommand{\DoGregorioImportLR}[2]{\GregorioImportLR*{index-cantuum/#2}{#3}{##1}{##2}}
