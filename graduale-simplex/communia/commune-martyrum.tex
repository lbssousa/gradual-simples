...
\MakeChantAntiphonPsalm{hi-sunt.1a2}{psalmi-ad-introitum}

\AllowPageFlush

\subsection{Entrada II}\label{subsection:communia/commune-martyrum/introitus-2}
\MakeChantAntiphonPsalm{sapientiam-sanctorum.4E}{psalmi-ad-introitum}
...
\MakeChantAntiphonPsalm{beati-qui-lavant.8G}{psalmi-ad-offertorium}

\AllowPageFlush

\subsection{Ofertório II}\label{subsection:communia/commune-martyrum/offertorium-2}
\MakeChantAntiphonPsalm{iusti-confitebuntur.1g}{psalmi-ad-offertorium}

\AllowPageFlush

\subsection{Comunhão I}\label{subsection:communia/commune-martyrum/communio-1}
\MakeChantAntiphonPsalm{qui-vult-venire-post-me.1f}{psalmi-ad-communionem}

\AllowPageFlush

\subsection{Comunhão II}\label{subsection:communia/commune-martyrum/communio-2}
\MakeChantAntiphonPsalm{habitabit.4E}{psalmi-ad-communionem}
