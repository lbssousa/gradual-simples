...
\MakeChantAntiphonPsalm{tunc-invocabis.7a}{introitus}
...
\MakeChantAntiphonPsalm{cum-facis-eleemosynam.1f}{offertorium}

\AllowPageFlush

\subsection{Comunhão}\label{subsection:tempus-quadragesimae/dominica-1/communio}
\MakeChantAntiphonPsalm{intellege.8c}{communio}