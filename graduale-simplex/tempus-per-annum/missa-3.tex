...
\MakeChantAntiphonPsalm{adspice-in-me.8c}{introitus}
...
\MakeChantAntiphonPsalm{deus-adiuvat-me.8G}{offertorium}

\AllowPageFlush

\subsection{Comunhão}\label{subsection:tempus-per-annum/missa-3/communio}
\MakeChantAntiphonPsalm{quaerite-primum.1g}{communio}