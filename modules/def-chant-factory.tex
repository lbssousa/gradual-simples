...
\newcommand{\SetLinkTextL}[1]{%
%\def\@Link@Text@L{#1}
}
\newcommand{\SetLinkTextR}[1]{%
%\def\@Link@Text@R{#1}
}
...
\NewDocumentCommand \SectionAntiphonPsalm { s O{} m O{} m O{} m m O{#5} } {
  \subsection{Antífona de #3}\IfBlankF{#4}{\label{#4}}
  \IfBlankF{#2}{%
    \begin{rubrica}
      \begin{center}
        #2
...
\NewDocumentCommand \SectionPsalm { s O{} m O{} m m m } {
  \subsection{Salmo #3 --- #5}\IfBlankF{#4}{\label{#4}}
  \IfBlankF{#2}{%
    \begin{rubrica}
      \begin{center}
        #2
...
\NewDocumentCommand \SectionPsalmMulti { s O{} m O{} m m m } {
  \subsection{Salmo #3 --- #5}\IfBlankF{#4}{\label{#4}}
  \IfBlankF{#2}{%
    \begin{rubrica}
      \begin{center}
